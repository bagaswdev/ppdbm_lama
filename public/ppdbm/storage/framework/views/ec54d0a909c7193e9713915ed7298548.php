...
<head>
    ...
    <link href="<?php echo e(asset('assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css')); ?>" rel="stylesheet" />
    <!-- end plugin css -->
...
<body data-base-url="<?php echo e(url('/')); ?>">
    ...
    <script src="<?php echo e(asset('assets/vendors/datatables.net-bs5/jquery.dataTables.bootstrap5.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\ppdb\public\ppdbm\resources\views/layout/master2.blade.php ENDPATH**/ ?>