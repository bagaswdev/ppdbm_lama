            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="card-body">
                            <h4 class="mb-4">Upload Berkas KIP Di bawah ini</h4>

                            <div class="row">
                                <div class="col-md-12 stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Upload Berkas KIP</h6>
                                            <div class="dropify-wrapper">
                                                ...
                                                <div class="dropify-errors-container">
                                                    <ul></ul>
                                                </div><input type="file" id="myDropify" name="tb_data_kip_file"><button
                                                    type="button" class="dropify-clear">Remove</>
